...
from src.graph.nodes import (
    ...
    video_analysis_node, make_save_state_node, note_review_node,
)
...
def _route_after_review(state: AgentState) -> str:
    ok = bool(state.get("notes_ok", False))
...
def _build_base_graph(store=None):
    ...
    builder.add_node("note_review", note_review_node)
    ...
    builder.add_edge("note_agent", "note_review")
